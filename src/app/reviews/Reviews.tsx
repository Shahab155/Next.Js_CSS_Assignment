   ...
   <section className="reviews-section" id='reviews'>
    {/* <!-- reviews heading and paragraph (upper part ) --> */}
       <div className="reviwes-head">
        ...
        <p className='reviews-para'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti dignissimos fuga magnam aliquid, accusantium error laudantium tenetur? Molestiae!</p>
        </div>
    ...
    {/* <!-- ----------------------reviews-item 1 ------------------- --> */}
        ...
        <div className="reviews-image-text">
            ...
            <div className="reviews-head-para">
                   <h2>Zia Khan</h2>
                   <p className="rev-para">Lorem ipsum dolor sit amet consectetur adipisicing elit. dignissimos, consequatur quidem soluta corrupti eaque.
